...
function temperaturas_intervalo($fecha_inicio, $fecha_final, $intervalo){
    require_once('conexion.php');
    $conn = new conexion();

    $queryTemperaturas = "SELECT UNIX_TIMESTAMP(`Fecha`), `Temperatura` FROM `historico` WHERE `Fecha` BETWEEN '$fecha_inicio' AND '$fecha_final';";
    $resultado = mysqli_query($conn->conectardb(), $queryTemperaturas);
...
<html lang="en">
<head>
    <title>Temperatura en el tiempo</title>
...
<body class="bg-dark text-white">
    ...
    <div class="container-fluid  my-5 bg-dark text-white">
        ...
        <h3 style="text-align:center">Registros de temperaturas a lo largo del tiempo.</h3>
        ...
        <script type="text/javascript">
            ...
            series: [{
                name: "<?php echo 'Temperaturas medidad entre el dia '.$dia_inicio.' del mes '.$mes_inicio.' del año '.$anio_inicio;
                echo '<br>y el día '.$dia_final.' del mes '.$mes_final.' del año '.$anio_final;
                  ?>",
                data: [<?php temperaturas_intervalo($fecha_inicio, $fecha_final, $intervalo);?>
                ]
            }],
        ...
        <div style="text-align: center;">
            <button type="button" class="btn btn-primary btn-lg" onclick="location.href='temperatura_historica.html'">Regresar</button>
        </div>
